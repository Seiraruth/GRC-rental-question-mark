        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div>
                        ...
                        <div class="relative group">
                            <div
                                ...
                                <svg class="h-5 w-5 text-gray-400 group-focus-within:text-blue-600" fill="none"
            ...
            <div id="carsGrid">
                ...
                @else
                    ...
                    <div
                        class="bg-white rounded-3xl shadow-xl shadow-gray-200/50 border border-gray-100 p-12 md:p-16 text-center">
