    ...
    <div class="grid lg:grid-cols-2 gap-16 items-center">
      ...
      <div class="text-center lg:text-left">
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
          <a href="#cars"
            ...
            Cari Mobil Sekarang
            <svg class="w-4 h-4 group-hover:translate-x-1 transition-transform duration-200" viewBox="0 0 24 24"
        ...
        <div class="flex flex-wrap gap-8 justify-center lg:justify-start mt-14 pt-10 border-t border-slate-700/50">
          <div class="text-center lg:text-left">
      ...
      <div class="hidden lg:flex items-center justify-center relative">
        <div class="relative w-full max-w-sm">
          <div class="absolute -top-4 -right-4 w-full h-full rounded-3xl bg-blue-600/20 border border-blue-500/20">
          </div>
          <div class="absolute -top-2 -right-2 w-full h-full rounded-3xl bg-blue-600/10 border border-blue-500/10">
          </div>
          ...
          <div
            ...
            <div class="mt-5 flex items-center gap-2 bg-blue-600/10 border border-blue-500/20 rounded-xl px-4 py-2.5">
